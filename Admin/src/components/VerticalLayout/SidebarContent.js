        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li><Link to="/dashboard">{props.t("View Infrastructure")}</Link>
                <ul className="sub-menu">
                    <li>
                      <Link to="/Asset">{props.t("Asset wise")}</Link>
                    </li>
                    <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link to="/Floor2">{props.t("Floor 2")}</Link>
                    </li>
                    <li>
                      <Link to="/Floor3">{props.t("Floor 3")}</Link>
                    </li>
                    <li>
                      <Link to="/#">{props.t("Floor 4")}</Link>
                    </li>
                    <li>
                      <Link to="/#">{props.t("Floor 5")}</Link>
                    </li>
                  </ul>
                    </li>
                  </ul>
                </li>
                <li><Link to="/dashboard2">{props.t("Edit Infrastructure")} </Link>
                <ul className="sub-menu">
                    <li>
                      <Link to="/Adddata">{props.t("Add")}</Link>
                    </li>
                    <li>
                      <Link to="/#">{props.t("Update")}</Link>
                    </li>
                  </ul>
                </li>
              </ul>
